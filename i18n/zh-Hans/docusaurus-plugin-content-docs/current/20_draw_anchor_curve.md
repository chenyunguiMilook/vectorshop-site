...
- ![alt text](./img/tool_round_anchor_tool.png "anchor"){width=28px height=28px} 工具用于绘制圆角锚点曲线。
- ![alt text](./img/tool_smooth_anchor_tool.png "smooth"){width=28px height=28px} 工具用于绘制圆角锚点曲线。
